    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 to-black text-white p-6">
      <div className="max-w-3xl mx-auto text-center">
        <div className="mb-8">
          ...
          <div className="text-xl font-semibold mb-2 text-blue-300">Coming Soon</div>
        </div>

        <div className="mb-10 space-y-6">
          <p className="text-xl">GPU accelerated ffmpeg from containers and VMs without GPU passthrough</p>
        </div>
